            ...
            <div className="flex items-center justify-between border-b border-white/10 pb-4">
              <div className="flex items-center gap-6">
                <button
                  ...
                  className={`text-lg font-bold flex items-center gap-2 pb-4 -mb-[17px] border-b-2 transition-colors ${activeTab === 'recommended' ? 'text-white border-primary' : 'text-text-secondary border-transparent hover:text-white'
                    }`}
                >
                ...
                <button
                  ...
                  className={`text-lg font-bold flex items-center gap-2 pb-4 -mb-[17px] border-b-2 transition-colors ${activeTab === 'watchlist' ? 'text-white border-red-500' : 'text-text-secondary border-transparent hover:text-white'
                    }`}
                >
                  My Watchlist
                  {watchlist.length > 0 && (
